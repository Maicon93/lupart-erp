<template>
    <LayoutComponent>
        <div class="row items-center justify-between q-mb-lg">
            ...
            <q-btn color="primary" no-caps icon="add" :label="$t('categories.actions.CREATE')" @click="openForm(null)" />
        </div>
        ...
        <CategoryForm v-model="showForm" :category="selectedCategory" @saved="loadData" />
    </LayoutComponent>
</template>
...
export default {
    ...
    components: { LayoutComponent, CategoryForm },
    ...
    data() {
        return {
            ...
            columns: [
                { name: 'name', label: this.$t('categories.fields.NAME'), field: 'name', align: 'left', sortable: true },
                { name: 'observation', label: this.$t('categories.fields.OBSERVATION'), field: 'observation', align: 'left' },
                { name: 'status', label: 'Status', field: 'status', align: 'center' },
                { name: 'actions', label: this.$t('categories.fields.ACTIONS'), field: 'actions', align: 'center' },
            ],
            statusOptions: [
                { label: this.$t('categories.filters.ALL'), value: 'all' },
